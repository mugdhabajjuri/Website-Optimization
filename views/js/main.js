...
function updatePositions() {
  ...
  // This stores the five constant phase values in an array
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var rows = window.innerHeight / 227; //for every 227px height one pizza
  var cols = window.innerWidth / 50; // for every 50px width one pizza
